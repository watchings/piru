...
- [/] Web 已支持 PBKDF2/AES-GCM 加密备份导入/导出；Android 和正式 encrypted envelope schema 待完成。
...
- [/] Android 已建立 API 24 兼容的通知 channel、Android 13+ 通知权限请求、Room 数据层和平台能力探测；Health Connect 实际授权、条码扫描、分享、文件系统待完成。
