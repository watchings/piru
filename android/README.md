...
The current slice includes a platform-local SQLite dose journal and a Room
schema/DAO for the migration path. The production migration must add Health
Connect (optional capability),
